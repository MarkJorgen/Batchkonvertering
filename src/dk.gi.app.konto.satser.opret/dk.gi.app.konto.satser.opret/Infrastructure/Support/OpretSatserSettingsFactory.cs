...
{
    public static class OpretSatserSettingsFactory
    {
        public static OpretSatserSettings Create(IReadOnlyDictionary<string, string> settings, string[] args)
        {
            return new OpretSatserSettings
            {
