...
{
    public static class KontoStartArealTjekStartupDiagnostics
    {
        public static IReadOnlyList<string> Build(JobConfiguration rawConfiguration, KontoStartArealTjekSettings settings)
        {
            return new List<string>
            {
                "[DIAG] Startup-diagnostik for konto.startarealtjek",
                ...
                "[DIAG] app.konto.arealtjek.antalaar=" + (settings != null ? settings.DefaultArealCheckYears.ToString() : "<tom>"),
                "[DIAG] BuildYearBefore=" + (settings != null ? settings.DefaultBuildYearBefore.ToString() : "<tom>"),
        ...
        private static string BuildSecretNormalizationLine(JobConfiguration rawConfiguration, KontoStartArealTjekSettings settings)
        {
