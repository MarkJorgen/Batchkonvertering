...
/// <summary>
    ...
    public partial class GIConsoleApp
    {
        ...
        internal AppStatus RunOrWaitForGoSignal(Func<AppStatus> callback, string uniqueMutexName, bool IfTimeoutRunAnyway)
        {
            AppStatus appStatus = new AppStatus(); // Default resultat OK
            appStatus.SetStatus = AppStatus.StateCode.OK;
            ...
            {
                Trace.LogError($"RunOrWaitForGoSignal slut: {appStatus.statecode}");
            }
            else
            {
                Trace.LogInformation($"RunOrWaitForGoSignal slut: {appStatus.statecode}");
            }
