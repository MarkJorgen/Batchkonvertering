...
namespace dk.gi.crm.app.faelles.cprvalidering
{
    ...
    public partial class Program
    {
        ...
        //******************************************************************************
        internal static string[] ekstraParametre = new string[] { "Ejer", "KundeId", "Sagstitel", "EmneId", "Emne", "Aktivitetskode", "Filnavn", "Skabelonnavn", "TilladSendTilDigitalPost" };
        ...
        internal static void SetKraevedeParametre(ref GIAppConfigure _configure)
        {
            ...
            _configure.requiredParametre = new string[] { "Mode", "Ejer", "KundeId", "Sagstitel", "EmneId", "Emne", "Aktivitetskode", "Filnavn", "Skabelonnavn", "TilladSendTilDigitalPost" }; // Her tilføj parameter navne til denne
        }
