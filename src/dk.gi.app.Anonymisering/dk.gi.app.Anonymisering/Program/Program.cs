...
/// 
/// Version: 2024 10 29
/// Sidste ændring: Rettet Eksempel AppSettings
/// 
...
namespace dk.gi.crm.app.anonymisering
{
    ...
    // <appSettings>
    //        <!-- CRM Forbindelse til DEV -->
    //        <add key="dev-OnPremise-CrmConnectionTemplate" value="Url=https://{0}/{1}/;AuthType=AD;Username={2};Password={3};Domain=gisb" />
    //        <add key="dev-CrmServerName" value="intcrmtst.gi.dk" />
    //        <add key="dev-CrmOrganisationName" value="CRMDEV" />
    //        <add key="dev-CrmUserName" value="crmprd@gisb.dk" />
    //        <add key="dev-CrmUserPassword" value="NwBWAH0AOwBQAHQAMwBxAEYAXABLAGQAOgByAHQAZABQAFYAYgBHAA==" />
    //        <!-- CRM Forbindelse til Test -->
    //        <add key="tst-OnPremise-CrmConnectionTemplate" value="Url=https://{0}/{1}/;AuthType=AD;Username={2};Password={3};Domain=gisb" />
    //        <add key="tst-CrmServerName" value="intcrmtst.gi.dk" />
    //        <add key="tst-CrmOrganisationName" value="CRMTST" />
    //        <add key="tst-CrmUserName" value="crmtst@gisb.dk" />
    //        <add key="tst-CrmUserPassword" value="PgBaAEAAXwBwACMALgA7AFwAWABpAHcAawBGAFUAKAApAFEARAAlAA==" />
    //        <!-- CRM Forbindelse til Produktion -->
    //        <add key="prd-OnPremise-CrmConnectionTemplate" value="Url=https://{0}/{1}/;AuthType=AD;Username={2};Password={3};Domain=gisb" />
    //        <add key="prd-CrmServerName" value="intcrmprd.gi.dk" />
    //        <add key="prd-CrmOrganisationName" value="CRMPRD" />
    //        <add key="prd-CrmUserName" value="crmprd@gisb.dk" />
    //        <add key="prd-CrmUserPassword" value="NwBWAH0AOwBQAHQAMwBxAEYAXABLAGQAOgByAHQAZABQAFYAYgBHAA==" />
    //        <!-- Microsoft Dynamics CRM Test Online Den Gamle version uden CrmClientId -->
    //        <add key="online-CrmConnectionTemplate" value="AuthType=ClientSecret;Url=https://{0};Clientid={2};ClientSecret={3};Authority=https://{1};RequireNewInstance = True;" />
    //        <add key="online-CrmServerName" value="gicrmtstbeforemigrate.crm4.dynamics.com/" />
    //        <add key="online-CrmOrganisationName" value="login.microsoftonline.com/d5356f0d-2d9d-4c6c-86ed-f15d0c7f72e7/oauth2/v2.0/authorize" />
    //        <add key="online-CrmUserName" value="90ea86ce-6853-42f3-a23a-a0097eda830d" />
    //        <add key="online-CrmUserPassword" value="VgBAAGUAKQBAAG8AdgBbAH0AfABVACQAQgBcAGYAVQBUAF0AdwBDAHIAeQBwAEYAaQBaAHIAVwB+AFMAfwBEAH4AUgBzACkAQgByACcAUAA=" />
    //        <!-- Microsoft Dynamics CRM Dev Online Den nye -->
    //        <add key="online-dev-CrmConnectionTemplate" value="AuthType=ClientSecret;Url=https://{0};Clientid={1};ClientSecret={2};Authority=https://{3};RequireNewInstance=True;" />
    //        <add key="online-dev-CrmServerName" value="gicrmdev.crm4.dynamics.com/" />
    //        <add key="online-dev-CrmClientId" value="90ea86ce-6853-42f3-a23a-a0097eda830d" />
    //        <add key="online-dev-CrmClientSecret" value="VgBAAGUAKQBAAG8AdgBbAH0AfABVACQAQgBcAGYAVQBUAF0AdwBDAHIAeQBwAEYAaQBaAHIAVwB+AFMAfwBEAH4AUgBzACkAQgByACcAUAA=" />
    //        <add key="online-dev-CrmAuthority" value="login.microsoftonline.com/d5356f0d-2d9d-4c6c-86ed-f15d0c7f72e7/oauth2/v2.0/authorize" />
    //        <!-- Microsoft Dynamics CRM Test Online Den nye -->
    //        <add key="online-tst-CrmConnectionTemplate" value="AuthType=ClientSecret;Url=https://{0};Clientid={1};ClientSecret={2};Authority=https://{3};RequireNewInstance=True;" />
    //        <add key="online-tst-CrmServerName" value="gicrmtst.crm4.dynamics.com/" />
    //        <add key="online-tst-CrmClientId" value="90ea86ce-6853-42f3-a23a-a0097eda830d" />
    //        <add key="online-tst-CrmClientSecret" value="VgBAAGUAKQBAAG8AdgBbAH0AfABVACQAQgBcAGYAVQBUAF0AdwBDAHIAeQBwAEYAaQBaAHIAVwB+AFMAfwBEAH4AUgBzACkAQgByACcAUAA=" />
    //        <add key="online-tst-CrmAuthority" value="login.microsoftonline.com/d5356f0d-2d9d-4c6c-86ed-f15d0c7f72e7/oauth2/v2.0/authorize" />
    //        <!-- Microsoft Dynamics CRM Produktikon Online Den nye -->
    //        <add key="online-prd-CrmConnectionTemplate" value="AuthType=ClientSecret;Url=https://{0};Clientid={1};ClientSecret={2};Authority=https://{3};RequireNewInstance=True;" />
    //        <add key="online-prd-CrmServerName" value="gicrmprd.crm4.dynamics.com/" />
    //        <add key="online-prd-CrmClientId" value="90ea86ce-6853-42f3-a23a-a0097eda830d" />
    //        <add key="online-prd-CrmClientSecret" value="VgBAAGUAKQBAAG8AdgBbAH0AfABVACQAQgBcAGYAVQBUAF0AdwBDAHIAeQBwAEYAaQBaAHIAVwB+AFMAfwBEAH4AUgBzACkAQgByACcAUAA=" />
    //        <add key="online-prd-CrmAuthority" value="login.microsoftonline.com/d5356f0d-2d9d-4c6c-86ed-f15d0c7f72e7/oauth2/v2.0/authorize" />
    //        <!-- CRM -->
    ...
    public partial class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            //argsList.Add("-MODE=REGISTRERING");
            //argsList.Add("-MODE=processkasserede");
            //argsList.Add("-MODE=processudbetalte");
            //args = argsList.ToArray();
            //Version.2025.02.12\dk.gi.crm.app.Anonymisering.exe - MODE = REGISTRERING
            //Version.2025.02.12\dk.gi.crm.app.Anonymisering.exe - MODE = VEDLIGEHOLD
            //Version.2025.02.12\dk.gi.crm.app.Anonymisering.exe - MODE = TEKNIKERSERVICE
            //Version.2025.02.12\dk.gi.crm.app.Anonymisering.exe - MODE = EJENDOM
            //Version.2025.02.12\dk.gi.crm.app.Anonymisering.exe - MODE = KONTAKT
            // TREKLIP 2020 05 06 JMW Treklip er pt. sat på pause   Version.2025.02.12\dk.gi.crm.app.Anonymisering.exe - MODE = TREKLIP
        ...
        public static void WriteLineTempTraceLog(string trace)
        {
            try
            {
