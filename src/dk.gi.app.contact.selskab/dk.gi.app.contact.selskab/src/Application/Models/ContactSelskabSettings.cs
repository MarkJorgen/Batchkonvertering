...
{
    public sealed class ContactSelskabSettings
    {
        ...
        private ContactSelskabSettings(
            string mode,
        ...
        public static ContactSelskabSettings Create(JobConfiguration configuration)
        {
            ...
            return new ContactSelskabSettings(
                ...
                CrmScalarSettingNormalizer.Normalize(configuration.Get("ServiceBusSessionId", "38852E10-DCF3-4453-A701-1A90AFDD1B14")),
