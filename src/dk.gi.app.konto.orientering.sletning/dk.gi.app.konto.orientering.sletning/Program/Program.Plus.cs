...
namespace dk.gi.app.konto.orientering.sletning
{
    ...
    public partial class Program
    {
        ...
        //******************************************************************************
        internal static string[] ekstraParametre = new string[] {"DatoOprettet", "KundeId", "BrugerNavn",
            "SagsEmne", "SagsType", "OpgaveAktivitetskode", "OpgaveAktivitetEmne", "SvarFrist" };
        ...
        internal static void SetKraevedeParametre(ref GIAppConfigure _configure)
        {
            ...
            _configure.requiredParametre = new string[] { "KundeId", "BrugerNavn",
                "SagsEmne", "SagsType", "OpgaveAktivitetskode", "OpgaveAktivitetEmne", "SvarFrist" }; // Her tilføj parameter navne til denne
        }
