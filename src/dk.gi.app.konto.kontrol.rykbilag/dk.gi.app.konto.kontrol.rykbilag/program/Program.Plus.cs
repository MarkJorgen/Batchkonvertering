...
namespace dk.gi.crm.app.konto.kontrol.rykbilag
{
    ...
    public partial class Program
    {
        ...
        //******************************************************************************
        internal static string[] ekstraParametre = new string[] { "KundeId", "Bruger", "OpgaveAktivitetKode", "OpgaveAktivitetEmne", "OpgaveAktivitetBeskrivelse", "DokumentNavn" };
        ...
        internal static void SetKraevedeParametre(ref GIAppConfigure _configure)
        {
            ...
            _configure.requiredParametre = new string[] { "KundeId", "Bruger", "OpgaveAktivitetKode", "OpgaveAktivitetEmne", "OpgaveAktivitetBeskrivelse", "DokumentNavn" }; // Her tilføj parameter navne til denne
        }
