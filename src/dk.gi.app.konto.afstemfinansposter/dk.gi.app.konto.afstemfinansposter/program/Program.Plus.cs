...
namespace dk.gi.crm.app.konto.afstemfinansposter
{
    ...
    public partial class Program
    {
        ...
        //******************************************************************************
        internal static string[] ekstraParametre = new string[] { "FinansAfstemning", "Integrationslog_fra", "Integrationslog_til", "IntegrationsNavn" };
        ...
        internal static void SetKraevedeParametre(ref GIAppConfigure _configure)
        {
            ...
            _configure.requiredParametre = new string[] { "FinansAfstemning", "Integrationslog_fra", "Integrationslog_til", "IntegrationsNavn" }; // Her tilføj parameter navne til denne
        }
