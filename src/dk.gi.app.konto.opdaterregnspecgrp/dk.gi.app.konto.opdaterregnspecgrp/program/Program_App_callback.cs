...
namespace dk.gi.crm.app.konto.opdaterregnspecgrp
{
    /// <summary>
    ...
    public partial class GIConsoleApp
    {
        ...
        private AppStatus CallBackFunction()
        {
            ...
            OpdaterRegnSpecGruppeRequest opdaterRegnSpecGruppeRequest = new OpdaterRegnSpecGruppeRequest(this.crmcontext)
            {
                Opdater = true,
                RegnskabsaarsagsKoder = new string[] { "05", "06" }
            };
            OpdaterRegnSpecGruppeResponse opdaterRegnSpecGruppeResponse = opdaterRegnSpecGruppeRequest.Execute<OpdaterRegnSpecGruppeResponse>();

            if (opdaterRegnSpecGruppeResponse.Status.IsOK() != true)
            {
