...
{
    public static class ContactRegistreringUdloebneStartupDiagnostics
    {
        public static IReadOnlyList<string> Build(JobConfiguration rawConfiguration, ContactRegistreringUdloebneOptaellingSettings settings)
        {
            return new List<string>
            {
                "[DIAG] Startup-diagnostik for contact.registreringudloebne.optaelling",
                ...
                "[DIAG] ServiceBusBaseUrl configured=" + ToJaNej(settings != null && !string.IsNullOrWhiteSpace(settings.ServiceBusBaseUrl)),
        ...
        private static string BuildSecretNormalizationLine(JobConfiguration rawConfiguration, ContactRegistreringUdloebneOptaellingSettings settings)
        {
