...
namespace dk.gi.crm.app.statstid.hentogopdater
{
    ...
    public partial class Program
    {
        ...
        //******************************************************************************
        internal static string[] ekstraParametre = new string[] { "KundeId", "BrugerKonto", "MailKonto", "SagsTypeKonkurs", "SagsEmneKonkurs", "OpgaveKodeKonkurs", "OpgaveEmneKonkurs",
                    "SagsTypeEjerskifte", "SagsEmneEjerskifte", "OpgaveKodeEjerskifte", "OpgaveEmneEjerskifte", "SagsTypeTvangsauktion", "SagsEmneTvangsauktion", "OpgaveKodeTvangsauktion",
                    "OpgaveEmneTvangsauktion", "MailTvangsauktion", "VentFoerNaesteKald"};
        ...
        internal static void SetKraevedeParametre(ref GIAppConfigure _configure)
        {
            ...
            _configure.requiredParametre = new string[] {  "KundeId", "BrugerKonto", "MailKonto", "SagsTypeKonkurs", "SagsEmneKonkurs", "OpgaveKodeKonkurs", "OpgaveEmneKonkurs",
                    "SagsTypeEjerskifte", "SagsEmneEjerskifte", "OpgaveKodeEjerskifte", "OpgaveEmneEjerskifte", "SagsTypeTvangsauktion", "SagsEmneTvangsauktion", "OpgaveKodeTvangsauktion",
                    "OpgaveEmneTvangsauktion", "MailTvangsauktion", "VentFoerNaesteKald" };  // Her tilføj parameter navne til denne
        }
        ...
        internal static AppStatus.StateCode ValidateKraevedeParametre(ref GIAppConfigure _configure)
        {
            ...
            ////****************************************************************************************************************************************************************************
            //// Åben for disse 2 linjer hvis du skal forbinde til MSMQ og app er startet fra MSMQ trigger (i GIConsoleApp-MSMQ.cs) så husk at
