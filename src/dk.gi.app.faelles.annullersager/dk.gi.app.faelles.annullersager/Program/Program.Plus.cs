...
namespace dk.gi.crm.app.faelles.annullersager
{
    ...
    public partial class Program
    {
        ...
        //******************************************************************************
        internal static string[] ekstraParametre = new string[] { "KendDinKundeSubjectId" };
        ...
        internal static void SetKraevedeParametre(ref GIAppConfigure _configure)
        {
            ...
            _configure.requiredParametre = new string[] { "KendDinKundeSubjectId" }; // Her tilføj parameter navne til denne
        }
